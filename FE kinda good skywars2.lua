--Made by offioa cry about it kids lol ez noob
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/GreenDeno/Venyx-UI-Library/main/source.lua"))()
local venyx = library.new("OffioaHub V4 PAID ACCESS", 5013109572)
...
-- first page
local page = venyx:addPage("offioa section", 5012544693)
